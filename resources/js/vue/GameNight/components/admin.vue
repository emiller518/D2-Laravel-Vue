<template>
    ...
    <div>
        ...
        <a href="/gamenight/">Home</a> <br>
        <a href="/gamenight/admin">Admin System</a> <br>
        <a href="/gamenight/compatible-games/1">Game 1 - Halo</a> <br>
        <a href="/gamenight/compatible-games">All Games</a> <br>
        <a href="/gamenight/matches">All Matches</a> <br>
        <a href="/gamenight/matches/1">First Match</a> <br>
        <a href="/gamenight/players/">All Players</a> <br>
        <a href="/gamenight/players/1">First Player</a> <br>
        <a href="/gamenight/session/072522">Session</a> <br>
    </div>
